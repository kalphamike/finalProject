  ...
  import { getAllCases } from 'src/redux/features/caseSlice';
  ...
  export default function DashboardAppPage() {
    ...
    // Fetch articles
    useEffect(() => {
      axios.get(`http://${API.host}:${API.port}/api/blog/list`)
    ...
    return (
      <>
        ...
        <Container maxWidth="xl">
          <Typography variant="h4" sx={{ mb: 5 }}>Welcome to CRM System</Typography>
          
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={3}>
              <AppWidgetSummary title="All numbers together" total={cases} icon={'iconoir:graph-up'} />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <AppWidgetSummary title="Boys" total={male} color="info" icon={'ant-design:man-outlined'} />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <AppWidgetSummary title="Girls" total={female} color="warning" icon={'ant-design:woman-outlined'} />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <AppWidgetSummary title="Children with disabilities" total={bellowTen} color="error" icon={'fontisto:paralysis-disability'} />
            </Grid>
            ...
            <Grid item xs={12} md={5} lg={4}>
              <AppCurrentVisits
                ...
                chartData={[
                  { label: 'Girls', value: disFemale },
                  { label: 'Boys   ', value: disMale },
            ...
            <Grid item xs={12} md={6} lg={8}>
              <AppConversionRates
                title="Provinces comparison"
                subheader="(+43%) In year"
                chartData={[
                  { label: 'Kigali City', value: casePerProvince.kigali  },
                  { label: 'Northern Province', value: casePerProvince.northern  },
                  { label: 'Southern Province', value: casePerProvince.southern },
                  { label: 'Western Province', value: casePerProvince.eastern },
                  { label: 'Eastern Province', value: casePerProvince.western },
                ]}
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={4}>
              <AppCurrentSubject
                title="Comparison of problem Categories"
                chartLabels={["Physical violence", 'Persecution', 'School drop-out', 'Children in risk', "Gender-based violence", 'In the family']}
                chartData={[
            ...
            {/* <Grid item xs={12} md={6} lg={8}>
              <AppNewsUpdate
                ...
                list={articles.map((article, index) => ({
                  ...
                  image: `http://${API.host}:${API.port}/api/blog/uploads/${article.blogPicture}`,
                }))}
              />
            </Grid> */}
            ...
            <Grid item xs={12} md={6} lg={4}>
              <AppOrderTimeline
                ...
                list={[...Array(5)].map((_, index) => ({
                  ...
                  title: [
                    '2019:'+' '+ years.yr2019 +'  '+'Children',
                    '2020:'+' '+ years.yr2020 +'  '+'Children',
                    '2021:'+' '+ years.yr2021 +'  '+'Children',
                    '2022:'+' '+ years.yr2022 +'  '+'Children',
                    '2023:'+' '+ years.yr2023 +'  '+'Children',
                  ][index],
                  type: `order${index + 1}`,
