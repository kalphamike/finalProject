...
export default function CasesPage() {
  ...
  const handleInputs = ({currentTarget: input}) => {
    setCaseDetails({...caseDetails, [input.name]: input.value});
  }
  ...
  return (
    <>
      ...
      <Box sx={{ height: 800, width: '100%' }}>
        <DataGrid rows={rows} columns={columns} pageSize={10} rowsPerPageOptions={[10]} checkboxSelection disableSelectionOnClick experimentalFeatures={{ newEditingApi: true }} />
      </Box>
      ...
      <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        { editable ?
          ...
          <TwoSidedContainer>
            <LeftSide>
              <TwoSidedContainer>
                ...
                <RightSide>
                  <TextField name="nameOfVictime" size='small' value={caseDetails.nameOfVictime} onChange={handleInputs} label="Name of victime" />
                </RightSide>
              </TwoSidedContainer>
              <TwoSidedContainer>
                <LeftSide>
                ...
                <RightSide>
                  <TextField name="ageOfVictime" size='small' value={caseDetails.ageOfVictime} onChange={handleInputs} label="Age of victime" />
                </RightSide>
              </TwoSidedContainer>
              <TwoSidedContainer>
                <LeftSide>
                ...
                <RightSide>
                  <TextField name="victimeResidence" size='small' value={caseDetails.victimeResidence} onChange={handleInputs} label="Victime residence" />
                </RightSide>
              </TwoSidedContainer>
              <TwoSidedContainer>
                <LeftSide>
                ...
                <RightSide>
                  <TextField name="victimeGender" size='small' value={caseDetails.victimeGender} onChange={handleInputs} label="Victime gender" />
                </RightSide>
              </TwoSidedContainer>
            </LeftSide>
            <RightSide>
              <TwoSidedContainer>
                ...
                <RightSide>
                  <TextField name="hasDisability" size='small' value={caseDetails.hasDisability} onChange={handleInputs} label="Has disability" />
                </RightSide>
              </TwoSidedContainer>
          ...
          <div style={{ display: 'flex', flexDirection: 'row', gap: '40px' }}>
            ...
            <Button variant='contained' size='small' color='success' onClick={updateCaseDetails}>{progress ? progress : "Emeza guhindura amakuru"}</Button>
          </div>
