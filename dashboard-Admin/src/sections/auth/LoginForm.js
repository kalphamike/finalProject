...
export default function LoginForm() {
      ...
      .then(response => {
        if(response.data.status === 401) {
          ...
          if(response.data.user.role === 'Admin') {
            ...
            window.location = `http://${API.host}:3001/dashboard/app`;
            ...
            window.location = `http://${API.host}:3002/dashboard/app`;
  ...
  return (
    <>
      <Typography variant="h4" gutterBottom> Injira kuri Child Rights System
</Typography>
