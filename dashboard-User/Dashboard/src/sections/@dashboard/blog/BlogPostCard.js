...
export default function BlogPostCard({ open, setSelectedItem, setOpen, post, index }) {
  const { blogId, blogTitle, blogBody, blogDate, blogPicture } = post;
      ...
      <Card sx={{ position: 'relative' }}>
        ...
        <CardContent sx={{ pt: 4, }}>
          ...
          <StyledTitle 
            ...
            variant="subtitle2" 
            underline="hover">{blogTitle}</StyledTitle>
        </CardContent>
      </Card>
    </Grid>
  );
